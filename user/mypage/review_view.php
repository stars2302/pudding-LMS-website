...
<main class="d-flex">
  <aside class="mypage_wrap">
    <div class="">
      ...
      <nav>
        <ul>
          <li class="content_stt link_tag mypage_tag"><a href="/pudding-LMS-website/user/mypage/mypage.php">내 강의실</a>
          </li>
          ...
          <div class="b_text02">
            <div class="d-flex align-items-center justify-content-between">
              <div class="d-flex align-items-center">
                ...
                <h5 class="b_text01 review_user">
                  <?= $card["username"]; ?>
                </h5>
                <h5 class="b_text02 dark review_name">
                  <?= $card["name"]; ?>
                </h5>
                <h5 class="b_text02 dark review_date">
                  <?= date('Y-m-d', strtotime($card["regdate"])); ?>
                </h5>
              </div>
            ...
            <div class="d-flex flex-row justify-content-end reply_btn_wrap_view">
              <a href="/pudding-LMS-website/user/mypage/review_update.php?rid=<?= $card["rid"]; ?>"
            ...
            if (isset($rs)) {
              foreach ($rs as $list) {
                ...
                <div class="b_text02 re_reply_content radius_12">
                  <div class="d-flex align-items-center">
                    <img src="../images/pdata/users/profile_img.png" class="userImg shodow_box" alt="프로필 이미지" />
                    <h5 class="b_text01 review_user">프바오</h5>
                    <h5 class="b_text02 dark review_name">
                      <?= date('Y-m-d', strtotime($list->r_regdate)); ?>
                    </h5>
                  </div>
                  <p>
                    <?= $list->r_content; ?>
