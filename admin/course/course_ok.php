<?php
  ...
  $sql = "INSERT INTO courses (name, price, price_status, level, due,due_status, act, content, thumbnail, youtube_name, youtube_url, image_table_id) 
  VALUES ('{$name}','{$price}','{$price_status}','{$level}','{$due}','{$due_status}','{$act}','{$content}','{$thumbnail}', '{$youtube_name}', '{$youtube_url}', '{$image_table_id}')";
