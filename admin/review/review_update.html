          ...
          <div class="card_container shadow_box border">
            ...
            <div class="b_text02 review_c_content border">
              ...
              <div class="b_text02 reply_content border">
               ...
               <textarea name="reply_create" id="reply_create" rows="6"> PHP를 배우기 위해서 급하게 들은 강의였는데, 생각보다 너무 친절하게 많은 예시를 들어 설명해주셔서 이해하기 쉬었습니다.기본기를 정리하는데 아주 좋은 강의였습니다</textarea>
              </div>
          
              <div class="d-flex flex-row justify-content-end reply_btn">
                <button class="btn btn-primary b_text01 reply_done">수정 완료</button>
                <button class="btn btn-dark b_text01 reply">수정 취소</button>
              </div>
            </div>
